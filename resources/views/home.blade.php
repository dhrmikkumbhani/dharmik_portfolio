...
@section('content')
                        ...
                        @foreach ($educations as $education)
                            <div class="position-relative mb-4">
                                ...
                                <p class="mb-2"><strong>{{ $education->association }}</strong> |
                                    <small>{{ $education->from }} - {{ $education->to }}</small></p>
                        ...
                        @foreach ($experiences as $experience)
                            <div class="position-relative mb-4">
                                ...
                                <p class="mb-2"><strong>{{ $experience->association }}</strong> |
                                    <small>{{ $experience->from }} - {{ $experience->to }}</small></p>
    ...
    <div class="container-fluid py-5" id="skill">
        <div class="container">
            ...
            <div class="row align-items-center">
                @php
                    $groupCount = max(1, floor($skills->count() / 3));
                    $groupedSkills = $skills->split($groupCount);
                @endphp

                @foreach ($groupedSkills as $row)
                    <div class="col-md-6">
